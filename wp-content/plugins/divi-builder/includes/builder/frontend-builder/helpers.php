	...
	$helpers['i18n'] = array(
		...
		'modals'                    => array(
			...
			'insertLayout'          => [
				...
				'premadeLayoutDesc' => esc_html__( 'Select from thousands of world-class premade layouts', 'et_builder' ),
				'savedLayoutDesc'   => esc_html__( 'Start from a layout in your Divi Library or clone an existing page', 'et_builder' ),
				'buildWithAIDesc'   => esc_html__( 'Simply describe your page, sit back, relax and let Divi AI build your page', 'et_builder' ),
			],
		),
		'selectControl'             => array(
